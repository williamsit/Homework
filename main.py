...
pybank_loc = os.path.join("PyBank", "Resources", "budget_data.csv")
...
pybanknew_loc = os.path.join("PyBank", "Resources", "budget_data_new.csv")
...
pybank_new_rd_loc = os.path.join("PyBank", "Resources", "budget_data_new.csv")
...
pybank_txt_loc = os.path.join("PyBank", "Resources", "budget_analysis.txt")
